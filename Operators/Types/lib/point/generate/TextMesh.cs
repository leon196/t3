...
namespace T3.Operators.Types.Id_cfd7c411_af1e_4044_81c2_8aec410e9a46
{
    public class TextMesh : Instance<TextMesh>
    {

        [Input(Guid = "48fe082f-0489-4456-8885-122d8476c6f1")]
        public readonly InputSlot<string> InputText = new InputSlot<string>();

        [Input(Guid = "3aa329d0-23e2-40b1-9a76-12e677cab5c3")]
            ...
            */
            ...
            foreach (var path in paths)
            {
                ...
                foreach (var q in p)
                {
                    ...
                    {
                        AddPoint(q.Points.Span[i], ref points);
                    }
                    
                    if (q.Points.Length > 0)
                        AddPoint(q.Points.Span[0], ref points);
        ...
        void AddPoint (PointF pp, ref List<PointT3> points)
        {
            PointT3 ppp = new PointT3();

            Vector3 pos = new Vector3(pp.X/32f, -pp.Y/32f+1f, 0f);
            ppp.Position = pos;
            ppp.W = 1f;
        ...
        [Output(Guid = "09abca8f-e13e-4637-98d0-0d8523e7f751")]
